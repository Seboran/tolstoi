...
---
import AnimatedBoutonMeContacter from '../../components/AnimatedBoutonMeContacter.astro'
...
<iframe title="album de musique Magaskarians de Eddy Rabeson" allow="autoplay *; encrypted-media *; fullscreen *; clipboard-write" frameborder="0" height="450" style="width:100%;max-width:660px;overflow:hidden;border-radius:10px;" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-top-navigation-by-user-activation" src="https://embed.music.apple.com/fr/album/madaskarians/1753699809"></iframe>
