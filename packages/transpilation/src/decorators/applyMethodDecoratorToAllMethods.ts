  ...
  return function (constructor: Function) {
    for (const propertyName of Object.getOwnPropertyNames(constructor.prototype)) {
      ...
      if (propertyName !== 'constructor' && typeof descriptor?.value === 'function') {
        const decoratedDescriptor = decorator(constructor.prototype, propertyName, descriptor)
        if (decoratedDescriptor) {
          Object.defineProperty(constructor.prototype, propertyName, decoratedDescriptor)
        }
      }
    }
  }
